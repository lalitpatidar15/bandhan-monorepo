...
const baseQueryWithLogout: BaseQueryFn<string | FetchArgs, unknown, FetchBaseQueryError> = async (args, api, extraOptions) => {
  ...
  const isAuthenticationRequest = /(?:^|\/)auth\/portal-login$/.test(url);
...
export const baseApi = createApi({
  ...
  tagTypes: ["FinancialDashboard", "Invoices", "Billing", "Recruiter", "Plans", "CurrentPlan", "Notifications", "UnreadCount"],
